...
export const translations = {
  en: {
    ...
    name_field_placeholder: 'Enter registered name',
    phone_password_field_label: 'Phone Number / Password',
    phone_password_field_placeholder: 'Enter phone number or password',
    login_btn: 'Login',
    authenticating: 'Verifying credentials...',
    common_login_sub: 'Enter your name and phone number or password to access your dashboard',
    new_customer_prompt: 'New customer?',
    create_account_link: 'Register Here',
    ...
    delivery_address: 'Home / Contact Address',
    delivery_notes: 'Special Order Instructions',
    order_timeline: 'Order Fulfillment Status',
    status_pending: 'Pending Review',
    status_accepted: 'Order Accepted',
    status_preparing: 'Preparing Items',
    status_ready: 'Ready for Store Pickup',
  ...
  ta: {
    ...
    name_field_label: 'பெயர்',
    name_field_placeholder: 'பதிவு செய்யப்பட்ட பெயரை உள்ளிடவும்',
    phone_password_field_label: 'தொலைபேசி எண் / கடவுச்சொல்',
    phone_password_field_placeholder: 'தொலைபேசி எண் அல்லது கடவுச்சொல் உள்ளிடவும்',
    login_btn: 'உள்நுழைக',
    authenticating: 'சரிபார்க்கிறது...',
    common_login_sub: 'உங்கள் கணக்கை அணுக பெயர் மற்றும் தொலைபேசி எண்/கடவுச்சொல்லை உள்ளிடவும்',
    new_customer_prompt: 'புதிய வாடிக்கையாளரா?',
    create_account_link: 'இங்கே பதிவு செய்யவும்',
    ...
    delivery_address: 'வீட்டு / தொடர்பு முகவரி',
    ...
    status_ready: 'வாங்க தயார் (Store Pickup)',
