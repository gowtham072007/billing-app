...
export const translations = {
  en: {
    ...
    phone_password_field_label: 'Phone Number',
    phone_password_field_placeholder: 'Enter phone number',
    login_btn: 'Login',
  ...
  ta: {
    ...
    phone_password_field_label: 'தொலைபேசி எண்',
    phone_password_field_placeholder: 'தொலைபேசி எண்ணை உள்ளிடவும்',
    login_btn: 'உள்நுழைக',
